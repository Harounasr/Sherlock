...
public interface UserRepository {
     ...
     * @return The fetched User entity, or throws NonExistentUserException if not found.
     * @throws NonExistentUserException If the user with the given username is not found.
     */
