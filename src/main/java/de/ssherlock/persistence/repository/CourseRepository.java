...
public interface CourseRepository {
    ...
    /**
     * Fetches the course for a given id.
     *
     * @param course the course with tge id set.
     * @return the course.
     * @throws PersistenceNonExistentCourseException if no courses were found.
     */
    Course getCourseById(Course course) throws PersistenceNonExistentCourseException;
}
